...
assert(plugin.includes('Version: 1.2.14'), 'Plugin header is 1.2.14');
assert(plugin.includes("define( 'SMC_VERSION', '1.2.14' )"), 'Runtime version is 1.2.14');
...
assert(readme.includes('Stable tag: 1.2.14'), 'Plugin readme stable tag is 1.2.14');
