...
assert(plugin.includes('Version: 1.2.10'), 'Plugin header is 1.2.10');
assert(plugin.includes("define( 'SMC_VERSION', '1.2.10' )"), 'Runtime version is 1.2.10');
...
assert(readme.includes('Stable tag: 1.2.10'), 'Plugin readme stable tag is 1.2.10');
