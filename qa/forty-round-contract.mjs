...
assert(plugin.includes('Version: 1.2.21'), 'Plugin header is 1.2.18');
assert(plugin.includes("define( 'SMC_VERSION', '1.2.21' )"), 'Runtime version is 1.2.18');
...
assert(readme.includes('Stable tag: 1.2.21'), 'Plugin readme stable tag is 1.2.18');
