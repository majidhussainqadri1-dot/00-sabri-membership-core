...
assert(plugin.includes('Version: 1.2.16'), 'Plugin header is 1.2.16');
assert(plugin.includes("define( 'SMC_VERSION', '1.2.16' )"), 'Runtime version is 1.2.16');
...
assert(readme.includes('Stable tag: 1.2.16'), 'Plugin readme stable tag is 1.2.16');
