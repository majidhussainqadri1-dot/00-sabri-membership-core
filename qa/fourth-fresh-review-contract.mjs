...
const checks=[
 ['runtime 1.2.43',main.includes('Version: 1.2.43')&&main.includes("SMC_VERSION', '1.2.43")],
 ...
 ['authentication provenance reads fresh File02 assertion time and not retired File00 session MFA',adv.includes("apply_filters( 'smc_file02_authentication_assurance_v1'")&&adv.includes("$verified_at = absint( $claim['verified_at'] ?? 0 )")&&!adv.includes('SMC_Security::session_verified_at')],
 ...
 ['advanced runtime fixture asserts File00 has no auth elevation',qa.includes('File 00 supplies no authentication elevation after MFA retirement')&&!qa.includes("define('SMC_VERSION', '1.2.34');")],
