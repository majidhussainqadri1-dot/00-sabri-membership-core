...
assert(workflow.includes("status='delivery_failed',is_current=0") && workflow.includes("SET is_current=1 WHERE id=%d"), 'Guardian delivery failure retires the failed generation and restores the previous current consent');
