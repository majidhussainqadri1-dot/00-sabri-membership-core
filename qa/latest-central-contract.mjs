...
console.log(`${checks.length}/${checks.length} latest-central static assertions passed for current File 00 1.2.43; historical 1.2.12 evidence remains provenance only.`);
