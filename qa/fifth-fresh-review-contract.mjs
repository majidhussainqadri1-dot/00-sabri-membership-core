...
const checks=[
 ['runtime 1.2.33',main.includes('Version: 1.2.33')&&main.includes("SMC_VERSION', '1.2.33")&&pkg.version==='1.2.33'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.33')&&readme.includes('= 1.2.33 =')],
