...
const checks=[
 ['runtime 1.2.44',main.includes('Version: 1.2.44')&&main.includes("SMC_VERSION', '1.2.44")&&pkg.version==='1.2.44'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.44')&&readme.includes('= 1.2.44 =')&&readme.includes('= 1.2.42 =')&&readme.includes('= 1.2.34 =')],
