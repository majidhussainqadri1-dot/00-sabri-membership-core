...
const checks=[
 ['runtime 1.2.20',main.includes('Version: 1.2.20')&&main.includes("SMC_VERSION', '1.2.20")&&pkg.version==='1.2.20'],
 ...
 ['release docs current and fifth changelog retained',readme.includes('Stable tag: 1.2.20')&&readme.includes('= 1.2.20 =')&&readme.includes('= 1.2.19 =')&&readme.includes('= 1.2.18 =')],
