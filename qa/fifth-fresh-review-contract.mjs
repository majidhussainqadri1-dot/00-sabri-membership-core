...
const checks=[
 ['runtime 1.2.40',main.includes('Version: 1.2.40')&&main.includes("SMC_VERSION', '1.2.40")&&pkg.version==='1.2.40'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.40')&&readme.includes('= 1.2.34 =')],
