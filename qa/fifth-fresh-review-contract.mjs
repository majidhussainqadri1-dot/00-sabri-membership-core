...
const checks=[
 ['runtime 1.2.38',main.includes('Version: 1.2.38')&&main.includes("SMC_VERSION', '1.2.38")&&pkg.version==='1.2.38'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.38')&&readme.includes('= 1.2.34 =')],
