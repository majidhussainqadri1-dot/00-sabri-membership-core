...
const checks=[
 ['runtime 1.2.35',main.includes('Version: 1.2.35')&&main.includes("SMC_VERSION', '1.2.35")&&pkg.version==='1.2.35'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.35')&&readme.includes('= 1.2.34 =')],
