...
const checks=[
 ['runtime 1.2.39',main.includes('Version: 1.2.39')&&main.includes("SMC_VERSION', '1.2.39")&&pkg.version==='1.2.39'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.39')&&readme.includes('= 1.2.34 =')],
