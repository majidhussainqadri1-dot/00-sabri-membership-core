...
const checks=[
 ['runtime 1.2.43',main.includes('Version: 1.2.43')&&main.includes("SMC_VERSION', '1.2.43")&&pkg.version==='1.2.43'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.43')&&readme.includes('= 1.2.43 =')&&readme.includes('= 1.2.42 =')&&readme.includes('= 1.2.34 =')],
 ['contracts current',main.includes("SMC_CONTRACT_VERSION', '1.2.3")&&main.includes("SMC_ADVANCED_TRUST_CONTRACT_VERSION', '1.0.0")],
