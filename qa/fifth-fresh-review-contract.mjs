...
const checks=[
 ['runtime 1.2.34',main.includes('Version: 1.2.34')&&main.includes("SMC_VERSION', '1.2.34")&&pkg.version==='1.2.34'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.34')&&readme.includes('= 1.2.33 =')],
