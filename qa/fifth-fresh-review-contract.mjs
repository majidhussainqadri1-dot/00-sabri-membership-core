...
const checks=[
 ['runtime 1.2.21',main.includes('Version: 1.2.21')&&main.includes("SMC_VERSION', '1.2.21")&&pkg.version==='1.2.21'],
 ...
 ['break-glass uses adaptive hardware policy at all three phases',(adv.match(/actor_meets_step_up\( \$[^,]+, 'break_glass'/g)||[]).length>=3&&adv.includes("'break_glass' => array( 4, 3, true, true )")],
 ...
 ['release docs current and fifth changelog retained',readme.includes('Stable tag: 1.2.21')&&readme.includes('= 1.2.20 =')&&readme.includes('= 1.2.19 =')&&readme.includes('= 1.2.18 =')],
