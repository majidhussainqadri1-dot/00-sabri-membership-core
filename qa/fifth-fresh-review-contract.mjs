...
const checks=[
 ['runtime 1.2.42',main.includes('Version: 1.2.42')&&main.includes("SMC_VERSION', '1.2.42")&&pkg.version==='1.2.42'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.42')&&readme.includes('= 1.2.34 =')],
