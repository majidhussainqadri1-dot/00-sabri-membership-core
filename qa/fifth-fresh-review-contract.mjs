...
const checks=[
 ['runtime 1.2.41',main.includes('Version: 1.2.41')&&main.includes("SMC_VERSION', '1.2.41")&&pkg.version==='1.2.41'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.41')&&readme.includes('= 1.2.34 =')],
