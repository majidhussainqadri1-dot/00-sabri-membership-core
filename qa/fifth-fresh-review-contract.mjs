...
const checks=[
 ['runtime 1.2.36',main.includes('Version: 1.2.36')&&main.includes("SMC_VERSION', '1.2.36")&&pkg.version==='1.2.36'],
 ...
 ['release docs current',readme.includes('Stable tag: 1.2.36')&&readme.includes('= 1.2.34 =')],
