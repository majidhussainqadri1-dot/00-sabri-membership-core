...
assert(plugin.includes('Version: 1.2.10') && plugin.includes("define( 'SMC_VERSION', '1.2.10' )"), 'Runtime version 1.2.10');
...
assert(registry.plugin_version === '1.2.10' && registry.database_version === '1.3.0', 'Traceability release identity');
