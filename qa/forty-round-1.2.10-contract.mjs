...
const checks = [
  ['current runtime version', plugin.includes("define( 'SMC_VERSION', '1.2.43' );")],
  ['current package version', packageJson.version === '1.2.43'],
...
console.log(`${checks.length}/${checks.length} retained forty-round corrective assertions passed for current runtime 1.2.43; historical 1.2.10 evidence remains immutable.`);
