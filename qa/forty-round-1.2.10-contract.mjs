...
const checks = [
  ['runtime version', plugin.includes("define( 'SMC_VERSION', '1.2.16' );")],
  ['package version', packageJson.version === '1.2.16'],
...
console.log(`${checks.length}/${checks.length} retained forty-round corrective assertions passed for runtime 1.2.16.`);
