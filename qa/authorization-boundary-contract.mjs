...
assert(main.includes('Version: 1.2.42'), 'Plugin header is 1.2.42');
assert(main.includes("define( 'SMC_VERSION', '1.2.42' )"), 'Runtime version is 1.2.42');
...
assert(auth.includes("rest_is_recovery_route( $route, $method )"), 'Legacy REST recovery matching is route-and-method exact before runtime retirement overrides it');
