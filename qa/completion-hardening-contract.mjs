...
check(main.includes('Version: 1.2.42'), 'plugin header 1.2.42');
check(main.includes("define( 'SMC_VERSION', '1.2.42' )"), 'runtime version 1.2.42');
...
check(readme.includes('Stable tag: 1.2.42'), 'readme stable tag');
