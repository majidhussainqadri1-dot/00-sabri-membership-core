...
check(main.includes('Version: 1.2.12'), 'plugin header 1.2.12');
check(main.includes("define( 'SMC_VERSION', '1.2.12' )"), 'runtime version 1.2.12');
...
check(readme.includes('Stable tag: 1.2.12'), 'readme stable tag');
