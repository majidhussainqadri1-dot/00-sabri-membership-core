...
check(main.includes('Version: 1.2.17'), 'plugin header 1.2.17');
check(main.includes("define( 'SMC_VERSION', '1.2.17' )"), 'runtime version 1.2.17');
...
check(readme.includes('Stable tag: 1.2.17'), 'readme stable tag');
