...
check(main.includes('Version: 1.2.10'), 'plugin header 1.2.10');
check(main.includes("define( 'SMC_VERSION', '1.2.10' )"), 'runtime version 1.2.10');
...
check(readme.includes('Stable tag: 1.2.10'), 'readme stable tag');
