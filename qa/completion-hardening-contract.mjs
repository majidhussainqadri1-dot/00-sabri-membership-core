...
check(main.includes('Version: 1.2.44'), 'plugin header 1.2.44');
check(main.includes("define( 'SMC_VERSION', '1.2.44' )"), 'runtime version 1.2.44');
...
check(readme.includes('Stable tag: 1.2.44'), 'readme stable tag');
