...
check(main.includes('Version: 1.2.37'), 'plugin header 1.2.37');
check(main.includes("define( 'SMC_VERSION', '1.2.37' )"), 'runtime version 1.2.37');
...
check(readme.includes('Stable tag: 1.2.37'), 'readme stable tag');
...
/* Historical MFA helpers remain covered as dormant migration/regression code; v1.2.37 removes their active routes and public requirement. */
