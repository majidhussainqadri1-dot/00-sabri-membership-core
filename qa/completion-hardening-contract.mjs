...
check(main.includes('Version: 1.2.14'), 'plugin header 1.2.14');
check(main.includes("define( 'SMC_VERSION', '1.2.14' )"), 'runtime version 1.2.14');
...
check(readme.includes('Stable tag: 1.2.14'), 'readme stable tag');
