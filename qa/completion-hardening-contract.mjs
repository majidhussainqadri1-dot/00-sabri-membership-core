...
check(main.includes('Version: 1.2.19'), 'plugin header 1.2.18');
check(main.includes("define( 'SMC_VERSION', '1.2.19' )"), 'runtime version 1.2.18');
...
check(readme.includes('Stable tag: 1.2.19'), 'readme stable tag');
