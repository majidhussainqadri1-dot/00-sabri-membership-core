...
check(main.includes('Version: 1.2.15'), 'plugin header 1.2.15');
check(main.includes("define( 'SMC_VERSION', '1.2.15' )"), 'runtime version 1.2.15');
...
check(readme.includes('Stable tag: 1.2.15'), 'readme stable tag');
