...
check(main.includes('Version: 1.2.16'), 'plugin header 1.2.16');
check(main.includes("define( 'SMC_VERSION', '1.2.16' )"), 'runtime version 1.2.16');
...
check(readme.includes('Stable tag: 1.2.16'), 'readme stable tag');
