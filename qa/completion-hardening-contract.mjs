...
check(main.includes('Version: 1.2.43'), 'plugin header 1.2.43');
check(main.includes("define( 'SMC_VERSION', '1.2.43' )"), 'runtime version 1.2.43');
...
check(readme.includes('Stable tag: 1.2.43'), 'readme stable tag');
