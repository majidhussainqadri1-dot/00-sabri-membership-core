...
check(main.includes('Version: 1.2.21'), 'plugin header 1.2.18');
check(main.includes("define( 'SMC_VERSION', '1.2.21' )"), 'runtime version 1.2.18');
...
check(readme.includes('Stable tag: 1.2.21'), 'readme stable tag');
