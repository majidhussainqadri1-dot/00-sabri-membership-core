...
assert(plugin.includes('Version: 1.2.39') && plugin.includes("define( 'SMC_DB_VERSION', '1.4.5' )") && plugin.includes("define( 'SMC_CONTRACT_VERSION', '1.2.2' )") && plugin.includes("define( 'SMC_CF01_CONTRACT_VERSION', '1.1.0' )") && plugin.includes("define( 'SMC_ADVANCED_TRUST_CONTRACT_VERSION', '1.0.0' )"), 'Current runtime identity 1.2.39/1.4.5/1.2.2 + CF-01 1.1.0 + advanced trust 1.0.0');
