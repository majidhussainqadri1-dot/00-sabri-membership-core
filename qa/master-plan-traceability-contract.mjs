...
assert(plugin.includes('Version: 1.2.12') && plugin.includes("define( 'SMC_DB_VERSION', '1.3.0' )") && plugin.includes("define( 'SMC_CONTRACT_VERSION', '1.2.0' )"), 'Current runtime identity 1.2.12/1.3.0/1.2.0');
const master = read('docs/FILE-00-MASTER-PLAN-2026.md');
assert(master.includes('Runtime implementation release: `1.2.12`'), 'Master index current runtime');
