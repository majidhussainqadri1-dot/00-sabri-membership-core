...
assert(plugin.includes('Version: 1.2.33') && plugin.includes("define( 'SMC_DB_VERSION', '1.4.4' )") && plugin.includes("define( 'SMC_CONTRACT_VERSION', '1.2.1' )") && plugin.includes("define( 'SMC_ADVANCED_TRUST_CONTRACT_VERSION', '1.0.0' )"), 'Current runtime identity 1.2.33/1.4.4/1.2.1 + advanced trust 1.0.0');
const master = read('docs/FILE-00-MASTER-PLAN-2026.md');
assert(master.includes('Runtime implementation release: `1.2.33`'), 'Master index current runtime');
