...
assert(data.plugin_version === '1.2.9', 'Registry version 1.2.9');
...
assert(data.dual_plan_completion?.release === '1.2.9', 'Dual-plan completion record');
...
assert(plugin.includes('Version: 1.2.9') && plugin.includes("define( 'SMC_DB_VERSION', '1.3.0' )"), 'Runtime identity');
const master = read('docs/FILE-00-MASTER-PLAN-2026.md');
assert(master.includes('Runtime implementation release: `1.2.9`'), 'Master index current');
const human = read('docs/FILE-00-IMPLEMENTATION-TRACEABILITY-1.2.9.md');
