...
$a=SMC_Contracts::assertions(1);
expect($a['eligible']===true && $a['can_message']===true,'Ordinary account becomes eligible only after both contacts.');
...
expect($a['eligible']===true,'Institutional account retains the explicit contact exemption.');
...
echo "Ilhami eligibility runtime: 6 PASS, 0 FAIL\n";
