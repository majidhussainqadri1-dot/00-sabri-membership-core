...
const checks = [
  ...
  ['stable tag 1.2.35', readme.includes('Stable tag: 1.2.35') && readme.includes('= 1.2.35 =')],
  ...
  ['active CI is immutable and v1.2.35-aligned', !workflowText.includes('contents: write') && workflowText.includes('00-sabri-membership-core-1.2.35.zip')],
