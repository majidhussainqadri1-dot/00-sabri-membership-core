...
const checks = [
  ['runtime 1.2.38', main.includes('Version: 1.2.38') && main.includes("SMC_VERSION', '1.2.38")],
  ['schema 1.4.4', main.includes("SMC_DB_VERSION', '1.4.4")],
  ['stable tag 1.2.38', readme.includes('Stable tag: 1.2.38') && readme.includes('= 1.2.38 =')],
  ...
  ['active CI is immutable and v1.2.38-aligned', !workflowText.includes('contents: write') && workflowText.includes('00-sabri-membership-core-1.2.38.zip')],
