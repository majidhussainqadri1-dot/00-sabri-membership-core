...
const checks = [
  ...
  ['stable tag 1.2.42', readme.includes('Stable tag: 1.2.42') && readme.includes('= 1.2.42 =')],
  ...
  ['active CI is immutable and v1.2.42-aligned', !workflowText.includes('contents: write') && workflowText.includes('00-sabri-membership-core-1.2.42.zip')],
