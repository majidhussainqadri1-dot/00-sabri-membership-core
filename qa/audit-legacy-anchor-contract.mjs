...
const checks = [
  ...
  ['stable tag 1.2.34', readme.includes('Stable tag: 1.2.34') && readme.includes('= 1.2.34 =')],
  ...
  ['active CI is immutable and v1.2.34-aligned', !workflowText.includes('contents: write') && !workflowText.includes('1.2.32') && workflowText.includes('00-sabri-membership-core-1.2.34.zip')],
