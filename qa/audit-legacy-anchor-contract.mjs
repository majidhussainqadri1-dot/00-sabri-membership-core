...
const checks = [
  ['runtime 1.2.33', main.includes('Version: 1.2.33') && main.includes("SMC_VERSION', '1.2.33")],
  ['schema 1.4.4', main.includes("SMC_DB_VERSION', '1.4.4")],
  ['stable tag 1.2.33', readme.includes('Stable tag: 1.2.33') && readme.includes('= 1.2.33 =')],
  ...
  ['active CI is immutable and v1.2.33-aligned', !workflowText.includes('contents: write') && !workflowText.includes('1.2.32') && workflowText.includes('00-sabri-membership-core-1.2.33.zip')],
