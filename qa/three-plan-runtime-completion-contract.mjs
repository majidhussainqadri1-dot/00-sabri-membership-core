...
const checks = [
  ['runtime 1.2.43', plugin.includes("define( 'SMC_VERSION', '1.2.43' );")],
...
console.log(`${checks.length}/${checks.length} three-plan completion assertions passed for current runtime 1.2.43 while historical traceability remains immutable.`);
