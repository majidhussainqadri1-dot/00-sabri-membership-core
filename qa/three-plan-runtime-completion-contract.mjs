...
const checks = [
  ['runtime 1.2.44', plugin.includes("define( 'SMC_VERSION', '1.2.44' );")],
...
console.log(`${checks.length}/${checks.length} three-plan completion assertions passed for current runtime 1.2.44 while historical traceability remains immutable.`);
