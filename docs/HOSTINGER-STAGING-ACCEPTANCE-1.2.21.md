# File 00 — Hostinger Staging Acceptance Delta — 1.2.21
...
|---|---|---|
| 00 Membership Core | runtime 1.2.21; final exact head and artifact supplied by GitHub CI/PR evidence | required candidate |
